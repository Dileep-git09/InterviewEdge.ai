...
var require_groovy = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		Prism.hooks.add("wrap", function(env) {
			if (env.language === "groovy" && env.type === "string") {
				...
				if (delimiter != "'") {
					...
					env.content = Prism.highlight(env.content.value, { expression: {
						pattern,
						lookbehind: true,
...
//#endregion
export { require_groovy as t };

//# sourceMappingURL=groovy-CClqbPde.js.map