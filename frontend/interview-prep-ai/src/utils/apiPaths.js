...
//export const BASE_URL = "https://interviewedge-bdc8.onrender.com";
...
export const API_PATHS = {
  ...
  IMAGE: {
    UPLOAD_IMAGE: "/api/upload-image",    // Upload profile picture
  },
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate-questions",       // Generate interview Q&A using Gemini
    GENERATE_EXPLANATION: "/api/ai/generate-explanation",   // Generate concept explanation using Gemini
    GENERATE_FROM_RESUME: "/api/ai/generate-from-resume",   // Upload resume & generate section-wise questions
  },
  SESSION: {
